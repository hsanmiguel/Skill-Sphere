            ...
            if (password_verify($password, $hashedPassword)) {
                ...
                if ($profileCheckStmt->num_rows > 0) {
                    ...
                    if ($role === 'superadmin') {
                        ...
                        header("Location: /Skill-Sphere/php/entry/setup.php");
                    }
                    exit();
                }
            } else {
...
if (isset($_POST['forgot_submit'])) {
    ...
    } elseif (empty($forgot_confirm_password)) {
        $forgotMsg = "Please confirm your new password.";
...
<head>
    ...
    <title>Sign In - Skill Sphere</title>
    <link rel="stylesheet" href="/Skill-Sphere/php/designs/header1.css">
    <link rel="stylesheet" href="/Skill-Sphere/php/designs/sign_in1.css">

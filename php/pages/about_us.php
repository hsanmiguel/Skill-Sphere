...
<head>
    ...
    <link rel="stylesheet" href="/Skill-Sphere/php/designs/about_us1.css">
            ...
            <div class="about-content">
                ...
                <div class="about-description">
                    ...
                    <div class="about-image">
                        <img src="/Skill-Sphere/php/assets/d_services.png" alt="People discussing services">
                    </div>
                </div>
            </div>
        </section>
        <section class="about-main">
            <div class="about-main-inner">
                <div class="quote-section">
                    ...
                    <img src="/Skill-Sphere/php/assets/planning_session.png" alt="Team planning session" class="quote-image">
                </div>
                        ...
                        foreach ($teamMembers as $member): ?>
                            <div class="member">
                                <div class="member-image">
                                    <img src="/Skill-Sphere/php/<?php echo $member['image']; ?>" alt="<?php echo $member['name']; ?>">
                                </div>
